      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
        ...
        >
          <StatsCard 
            ...
            change={`${stats.winRate.toFixed(1)}%`} 
            positive={true} 
        ...
        >
          <StatsCard 
            ...
            change={`${(100 - stats.winRate).toFixed(1)}%`} 
            positive={false} 
        ...
        >
          <StatsCard 
            ...
            change={`${stats.totalTrades > 0 ? (stats.breakevens / stats.totalTrades * 100).toFixed(1) : 0}%`} 
            icon={<Target className="w-5 h-5" />} 
          />
        </motion.div>
        ...
        >
          <StatsCard 
            title="PNL %" 
            value={`${stats.pnlPercentage > 0 ? '+' : ''}${stats.pnlPercentage.toFixed(2)}%`} 
            positive={stats.pnlPercentage >= 0} 
            icon={<BarChart3 className="w-5 h-5" />} 
          />
        </motion.div>
      </div>
