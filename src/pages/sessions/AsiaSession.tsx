  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold text-foreground">Asia ORB Session</h1>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex justify-between">
                ...
                <span className="text-card-foreground">20:00 - 05:00 GMT</span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">Primary Pairs</span>
                <span className="text-card-foreground">AUD/JPY, NZD/JPY</span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">Volatility</span>
                <span className="text-card-foreground">Low-Medium</span>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-success">58%</span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">Avg R:R</span>
                <span className="text-card-foreground">1:1.8</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-card shadow-card border-border">
          ...
          <CardContent>
            <div className="text-sm text-muted-foreground">
              Asia session typically shows consolidation patterns. Focus on range breakouts during Sydney open.
            </div>
          </CardContent>
        </Card>
      </div>
